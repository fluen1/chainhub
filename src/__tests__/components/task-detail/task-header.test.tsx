...
describe('TaskHeader', () => {
  ...
  it('viser titel, status og prioritet', () => {
    render(<TaskHeader {...base} dueDate={null} urgency="none" />)
  ...
  it('viser Forfalden-badge ved urgency=overdue', () => {
    render(<TaskHeader {...base} dueDate={new Date('2026-04-10')} urgency="overdue" />)
    expect(screen.getByText('Forfalden')).toBeInTheDocument()
  })

  it('viser Haster-badge ved urgency=due-soon', () => {
    render(<TaskHeader {...base} dueDate={new Date('2026-04-20')} urgency="due-soon" />)
  ...
  it('renderer editButton-slot', () => {
    render(
      <TaskHeader {...base} dueDate={null} urgency="none" editButton={<button>Redigér</button>} />
    )
