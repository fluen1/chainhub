...
describe('AnthropicDirectClient', () => {
  ...
  it('sends request and returns normalized response', async () => {
    ...
    expect(mockCreate).toHaveBeenCalledWith(
      expect.objectContaining({ model: 'claude-sonnet-4-6', max_tokens: 100 })
    )
