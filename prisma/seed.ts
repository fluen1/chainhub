...
async function main() {
  ...
  const companyData = [
    {
      ...
      postal_code: '1260',
      status: 'aktiv',
      notes: 'Moderselskab for hele kæden',
      latitude: 55.6839,
      longitude: 12.5876,
    },
    {
  ...
  const cpData = [
    ...
    },
    {
      ...
      anciennity_start: new Date('2022-03-15'),
    },
    {
      id: uid(3004),
      company_id: uid(1004),
      ...
      anciennity_start: new Date('2024-09-01'),
    },
    {
      id: uid(3005),
      company_id: uid(1005),
      ...
      anciennity_start: new Date('2023-01-01'),
    },
    {
      id: uid(3006),
      company_id: uid(1006),
      ...
      anciennity_start: new Date('2023-08-01'),
    },
    {
      id: uid(3007),
      company_id: uid(1000),
  ...
  const contractData = [
    // Ejeraftaler — STRENGT_FORTROLIG
    {
      ...
      effective_date: new Date('2020-01-01'),
      notes: 'Original ejeraftale. Forkøbsret i §8, tag-along i §9.',
    },
    {
      id: uid(5002),
      company_id: uid(1002),
    ...
    // Direktørkontrakter
    {
      id: uid(5010),
      company_id: uid(1001),
      system_type: 'DIREKTOERKONTRAKT' as const,
      display_name: 'Direktørkontrakt — Anders Jensen',
      status: 'AKTIV' as const,
      sensitivity: 'FORTROLIG' as const,
      effective_date: new Date('2020-01-01'),
    ...
    },
    {
      ...
      company_id: uid(1002),
      system_type: 'DIREKTOERKONTRAKT' as const,
      display_name: 'Direktørkontrakt — Rikke Nielsen',
      status: 'AKTIV' as const,
      sensitivity: 'FORTROLIG' as const,
      effective_date: new Date('2021-06-01'),
      notice_period_days: 180,
    ...
    // Lejekontrakter — udløber snart!
    {
      id: uid(5020),
      company_id: uid(1001),
      system_type: 'LEJEKONTRAKT_ERHVERV' as const,
      display_name: 'Lejekontrakt — Østerbrogade 123',
      status: 'AKTIV' as const,
      sensitivity: 'INTERN' as const,
      effective_date: new Date('2020-01-01'),
      expiry_date: daysFromNow(25),
      notice_period_days: 90,
      notes: '⚠️ Udløber snart — forhandling påkrævet',
    },
    {
      id: uid(5021),
      company_id: uid(1002),
      system_type: 'LEJEKONTRAKT_ERHVERV' as const,
      display_name: 'Lejekontrakt — Frederiksgade 45',
      status: 'AKTIV' as const,
      sensitivity: 'INTERN' as const,
      effective_date: new Date('2021-06-01'),
      expiry_date: daysFromNow(85),
    },
    {
      id: uid(5022),
      company_id: uid(1003),
      system_type: 'LEJEKONTRAKT_ERHVERV' as const,
      display_name: 'Lejekontrakt — Vesterbrogade 78',
      status: 'AKTIV' as const,
      sensitivity: 'INTERN' as const,
      effective_date: new Date('2022-03-15'),
      expiry_date: new Date('2027-03-14'),
    },
    // Forsikringer
    {
      id: uid(5030),
      company_id: uid(1001),
      system_type: 'FORSIKRING' as const,
      display_name: 'Erhvervsansvarsforsikring — Østerbro',
      status: 'AKTIV' as const,
    ...
    },
    {
      ...
      company_id: uid(1002),
      system_type: 'FORSIKRING' as const,
      display_name: 'Erhvervsansvarsforsikring — Aarhus',
      status: 'AKTIV' as const,
      sensitivity: 'STANDARD' as const,
      effective_date: new Date('2024-01-01'),
      expiry_date: new Date('2026-12-31'),
    ...
    // NDA'er
    {
      id: uid(5040),
      company_id: uid(1004),
      system_type: 'NDA' as const,
      display_name: 'NDA — Nordhavn opkøbsforhandling',
      status: 'AKTIV' as const,
      sensitivity: 'FORTROLIG' as const,
    ...
    // Ansættelseskontrakter
    {
      id: uid(5070),
      company_id: uid(1001),
      system_type: 'ANSAETTELSE_FUNKTIONAER' as const,
      display_name: 'Ansættelseskontrakt — Tandplejer Sara Holm',
      status: 'AKTIV' as const,
      sensitivity: 'FORTROLIG' as const,
      effective_date: new Date('2022-04-01'),
    },
    {
      id: uid(5071),
      company_id: uid(1001),
      system_type: 'ANSAETTELSE_FUNKTIONAER' as const,
      display_name: 'Ansættelseskontrakt — Klinikassistent Maja Bech',
      status: 'AKTIV' as const,
      sensitivity: 'FORTROLIG' as const,
    ...
    // Opsagt kontrakt
    {
      ...
      termination_date: daysFromNow(45),
    },
    // Vedtægter
    {
      id: uid(5100),
  ...
  const caseData = [
    {
      id: uid(6001),
      case_number: 'SAG-2024-001',
      title: 'Opkøb af Nordhavn-klinik',
      case_type: 'TRANSAKTION' as const,
      case_subtype: 'VIRKSOMHEDSKOEB' as const,
      status: 'AKTIV' as const,
      sensitivity: 'STRENGT_FORTROLIG' as const,
      description:
    ...
    {
      id: uid(6002),
      case_number: 'SAG-2024-002',
      title: 'Lejeforhandling Østerbro',
      case_type: 'KONTRAKT' as const,
      case_subtype: 'FORNYELSE' as const,
      status: 'AKTIV' as const,
      sensitivity: 'INTERN' as const,
      description: 'Lejekontrakten udløber om 25 dage. Udlejer kræver 12% huslejestigning.',
      responsible_id: maria.id,
      due_date: daysFromNow(14),
    },
    {
      id: uid(6003),
      case_number: 'SAG-2024-003',
      title: 'GDPR-audit Q1 2025',
      case_type: 'COMPLIANCE' as const,
      case_subtype: 'GDPR' as const,
      status: 'AKTIV' as const,
      sensitivity: 'INTERN' as const,
      description:
        'Årlig GDPR-gennemgang af alle klinikker. Fokus på patientsamtykke og journaldata.',
      responsible_id: maria.id,
    },
    {
      id: uid(6004),
      ...
      status: 'AKTIV' as const,
      sensitivity: 'STANDARD' as const,
      description: 'Leverandørskifte pga. prisforhøjelse. Ny leverandør identificeret.',
    },
    {
      id: uid(6005),
      case_number: 'SAG-2023-008',
      title: 'Arbejdsmiljøtilsyn — Aarhus',
      case_type: 'COMPLIANCE' as const,
      case_subtype: 'ARBEJDSMILJOE' as const,
      status: 'LUKKET' as const,
      sensitivity: 'INTERN' as const,
      description: 'Arbejdstilsynet gennemførte besøg d. 15/9. Ingen påbud.',
      closed_at: daysAgo(60),
    },
    {
      id: uid(6006),
      case_number: 'SAG-2023-012',
      title: 'Generalforsamling 2024',
      case_type: 'GOVERNANCE' as const,
      case_subtype: 'GENERALFORSAMLING' as const,
      status: 'LUKKET' as const,
      sensitivity: 'INTERN' as const,
      description: 'Ordinær generalforsamling afholdt d. 28/3 2024.',
      closed_at: daysAgo(350),
    },
  ]
  ...
  const ccData = [
    ...
    { case_id: uid(6003), company_id: uid(1001) },
    { case_id: uid(6003), company_id: uid(1002) },
    { case_id: uid(6003), company_id: uid(1003) },
  ...
  const taskData = [
    ...
    {
      id: uid(7001),
      title: 'Gennemgå due diligence-rapport fra revisor',
      case_id: uid(6001),
      assigned_to: philip.id,
      priority: 'HOEJ' as const,
      due_date: daysAgo(3),
      status: 'AKTIV_TASK' as const,
    },
    {
      id: uid(7002),
      title: 'Send revideret NDA til modpart',
      case_id: uid(6001),
      assigned_to: maria.id,
      priority: 'KRITISK' as const,
      due_date: daysAgo(1),
      status: 'AKTIV_TASK' as const,
    },
    // Denne uge
    {
      id: uid(7003),
      title: 'Udarbejd modbud til udlejer (Østerbro)',
      case_id: uid(6002),
      assigned_to: maria.id,
      priority: 'KRITISK' as const,
    ...
    {
      id: uid(7004),
      title: 'Indhent tilbud fra ny leverandør',
      case_id: uid(6004),
      assigned_to: thomas.id,
    ...
    {
      id: uid(7005),
      title: 'GDPR-tjekliste for Østerbro-klinik',
      case_id: uid(6003),
      assigned_to: maria.id,
      priority: 'MELLEM' as const,
    ...
    {
      id: uid(7006),
      title: 'GDPR-tjekliste for Aarhus-klinik',
      case_id: uid(6003),
      assigned_to: maria.id,
      priority: 'MELLEM' as const,
    ...
    {
      id: uid(7007),
      title: 'GDPR-tjekliste for Vesterbro-klinik',
      case_id: uid(6003),
      assigned_to: maria.id,
      priority: 'MELLEM' as const,
      due_date: daysFromNow(14),
    ...
    {
      id: uid(7008),
      title: 'Opdater vedtægter efter kapitalforhøjelse',
      assigned_to: philip.id,
      priority: 'LAV' as const,
      due_date: daysFromNow(45),
      status: 'NY' as const,
    },
    {
      id: uid(7009),
      title: 'Årlig forsikringsgennemgang',
      assigned_to: thomas.id,
      priority: 'MELLEM' as const,
    ...
    {
      id: uid(7010),
      title: 'Underskrift af ejeraftale — Nordhavn (initial)',
      case_id: uid(6001),
      assigned_to: philip.id,
      priority: 'HOEJ' as const,
      due_date: daysAgo(30),
  ...
  const finData = [
    ...
    {
      company_id: uid(1001),
      metric_type: 'OMSAETNING' as const,
      period_year: 2024,
      value: 8200000,
      source: 'REVIDERET' as const,
    },
    {
      company_id: uid(1001),
      metric_type: 'EBITDA' as const,
      period_year: 2024,
      value: 1850000,
      source: 'REVIDERET' as const,
    },
  ...
  const docData = [
    {
      id: uid(8001),
      company_id: uid(1001),
      title: 'Ejeraftale — Østerbro (underskrevet)',
      file_url: '/docs/ejeraftale-osterbro.pdf',
      file_name: 'ejeraftale-osterbro.pdf',
    ...
    },
    {
      id: uid(8002),
      company_id: uid(1001),
      title: 'Lejekontrakt — Østerbrogade 123',
      file_url: '/docs/lejekontrakt-osterbro.pdf',
      file_name: 'lejekontrakt-osterbro.pdf',
    ...
    },
    {
      id: uid(8003),
      company_id: uid(1002),
      title: 'Ejeraftale — Aarhus (underskrevet)',
      file_url: '/docs/ejeraftale-aarhus.pdf',
      file_name: 'ejeraftale-aarhus.pdf',
    ...
    },
    {
      id: uid(8005),
      company_id: uid(1004),
      title: 'NDA — Nordhavn forhandling',
      file_url: '/docs/nda-nordhavn.pdf',
      file_name: 'nda-nordhavn.pdf',
    ...
    },
    {
      id: uid(8006),
      company_id: uid(1001),
      title: 'Erhvervsansvarsforsikring — police 2024',
      file_url: '/docs/forsikring-osterbro-2024.pdf',
      file_name: 'forsikring-osterbro-2024.pdf',
    ...
    },
    {
      id: uid(8008),
      case_id: uid(6001),
      title: 'Due diligence rapport — Nordhavn',
      file_url: '/docs/dd-nordhavn.pdf',
      file_name: 'dd-nordhavn.pdf',
  ...
  const auditData = [
    {
      ...
      user_id: philip.id,
      action: 'OPRETTET',
      resource_type: 'KONTRAKT',
      resource_id: uid(5080),
      created_at: daysAgo(5),
    },
    {
      id: uid(9002),
      user_id: maria.id,
      action: 'STATUS_AENDRET',
      resource_type: 'SAG',
      resource_id: uid(6002),
    ...
    },
    {
      ...
      user_id: thomas.id,
      action: 'OPDATERET',
      resource_type: 'SELSKAB',
      resource_id: uid(1005),
