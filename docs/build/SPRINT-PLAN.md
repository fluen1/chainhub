...
Sprint-gate: npm install --legacy-peer-deps → prisma generate → tsc --noEmit → next build + /companies og /persons loader.
```
...
Sprint-gate: npm install --legacy-peer-deps → prisma generate → tsc --noEmit → next build + /contracts loader.
```
...
Sprint-gate: npm install --legacy-peer-deps → prisma generate → tsc --noEmit → next build + /cases og /tasks loader.
```
