...
3. OPBEVARINGSPLIGT
   Udfyld must_retain_until for alle 33 kontrakttyper baseret på:
...
4. KONCERNINTERNE AFTALER
   KT-27 (intern serviceaftale/management fee), KT-28 (royalty/licensaftale), KT-33 (intercompany-lån)
...
1. TRANSFER PRICING
   KT-27 (intern serviceaftale/management fee) og KT-28 (royalty/licensaftale) er nu i kataloget.
...
2. FINANSIELLE AFTALERS METADATA
   KT-04 (aktionærlåneaftale), KT-33 (intercompany-lån), KT-31 (kassekreditaftale/bankfacilitet):
...
3. NØGLETAL-KOBLING
   Økonomi-modulet i kravspec-legalhub.md nævner "nøgletal pr. selskab".
...
4. UDBYTTELOGIK
   ...
   Er der tilstrækkelig kobling fra KT-04 (aktionærlåneaftale),
   KT-27 (intern serviceaftale/management fee) til udbytteberegning?
...
1. ANSÆTTELSESKONTRAKT-DISTINKTIONER
   Kataloget har nu KT-07 (ansættelseskontrakt funktionær) og KT-08 (ansættelseskontrakt ikke-funktionær).
...
3. PRØVETID-LOGIK
   probation_end_date er på KT-07/KT-08.
...
5. FRATRÆDELSESFLOW
   KT-11 (fratrædelsesaftale), KT-12 (konkurrenceklausulaftale), KT-13 (personalehåndbog).
...
5. SØGBARHED OG OVERBLIK
   ...
   33 kontrakttyper og 20 selskaber?
...
1. PERSONDATA I KONTRAKTFELTER
   Gennemgå alle 33 kontrakttypers felter.
...
```
v0.3 (QA-R3-rettet):
  [M1] roller-og-tilladelser.md filnavn rettet — 4 forekomster i dokumentindhold:
       ROLLER-OG-TILLADELSER.md → roller-og-tilladelser.md
       (Instruktion til Claude Code linje 17, DEA-01 prompt,
        DEA-07 prompt, Master-prompt linje 414)
  [K2] Overset KRAVSPEC.md-rettelse fra v0.2:
       KRAVSPEC.md → kravspec-legalhub.md (DEA-04 NØGLETAL-KOBLING)

v0.3 (QA-R2-rettet):
  [K1] Versionsnummer rettet: 0.2 → 0.3 — QA-R2-rettet
  [K2] 3 forekomster af "36 kontrakttyper" rettet til 33:
       DEA-01 (opbevaringspligt), DEA-06 (søgbarhed), DEA-07 (persondata)
  [K3] DEA-02 linje 115: forkerte KT-numre rettet:
       KT-18, KT-19, KT-22 → KT-27, KT-28, KT-33
  [K4] DEA-04 forkerte KT-numre rettet (4 linjer):
       KT-18, KT-19 → KT-27, KT-28 (transfer pricing)
       KT-11, KT-22, KT-23 → KT-04, KT-33, KT-31 (finansielle aftaler)
       KT-11, KT-18 → KT-04, KT-27 (udbyttelogik)
  [K5] DEA-05 forkerte KT-numre rettet (3 linjer):
       KT-03a, KT-03b, KT-04, KT-05 → KT-07, KT-08 (ansættelseskontrakter)
       KT-03a/b → KT-07/KT-08 (prøvetid)
       KT-26, KT-27, KT-29 → KT-11, KT-12, KT-13 (fratrædelsesflow)
...
*DEA-PROMPTS.md v0.3 — QA-R3-rettet.*
