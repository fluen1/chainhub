...
```
v0.3 (QA-R2-rettet):
  [K1] roller-og-tilladelser.md filnavn rettet — 3 forekomster i dokumentindhold:
       ROLLER-OG-TILLADELSER.md → roller-og-tilladelser.md
       (DEA-01 primære spec-dokumenter, DEA-07 primære spec-dokumenter,
        aktiveringstabel)
  [K2] Lowercase rollenavn rettet — BA-11 privilege escalation:
...
*AGENT-ROSTER.md v0.3 — QA-R2-rettet.*
