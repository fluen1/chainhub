...
## FASE 0 — SPEC-TILLAEG-v2 DEA-CHALLENGE (2026-03-12)

---

### DEC-F0-001: Multi-tenancy på nye tabeller — ACCEPTED
**Agent:** DEA-07 (Sikkerhed) + DEA-01 (Juridisk)
...
som første kolonne efter `id`. BA-02 tilføjer dette til schema inden migrationer.
...
**Agent:** DEA-01 (Juridisk) + DEA-07 (Sikkerhed)
...
**Agent:** DEA-02 (Franchise & Kædestruktur)
...
**Konsekvens:** BA-04/BA-05 implementerer urgency panel med individuelle links.

---

### DEC-F0-007: Global søgning flyttes til Sprint 7 (begrænset scope) — ACCEPTED
**Agent:** DEA-03 (Kommerciel Produktstrateg)
...
**Agent:** DEA-05 (HR & Ansættelsesret)
...
**Agent:** DEA-04 (Finansiel Controller)
...
Implementeres i Sprint 7 (BA-04).
...
**Konsekvens:** Sprint 8 scope tilføjer simpel email-digest. BA-06 implementerer.

---

### DEC-F0-015: Besøgshandlingspunkter — inline oprettelse — ACCEPTED
**Agent:** DEA-08 (UX) + BA-12 (Testbruger)
...
**Konsekvens:** BA-04/BA-05 implementerer inline task-oprettelse på besøgsdetaljeside.
...
### DEC-F0-017: DEA-08 UI-løsninger godkendt som implementeringsguide — ACCEPTED
**Agent:** DEA-08 (UX)
**Indsigelse:** (Ingen indsigelse — positivt fund)
**Beslutning:** ACCEPTED — DEA-08's konkrete layout-beskrivelser (Tailwind-klasser)
bruges som bindende implementeringsguide for BA-04 i Sprint 7:
...
Se DEA-08 analyse i DECISIONS.md for Tailwind-specifikationer.
...
UNDTAGELSE: Hvis BA-06 vurderer at R2-integration er <4 timer ekstraarbejde,
